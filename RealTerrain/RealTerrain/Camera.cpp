...
void Camera::Move(MoveDirection direction, float deltaTime)
{
	...
	{
		{MoveDirection::Forward, {&Camera::forward, 1.f}},
		{MoveDirection::Backward, {&Camera::forward, -1.f}},
		{MoveDirection::Left, {&Camera::right, -1.f}},
		{MoveDirection::Right, {&Camera::right, 1.f}},
		{MoveDirection::Up, {&Camera::up, 1.f}},
		{MoveDirection::Down, {&Camera::up, -1.f}},
	};
