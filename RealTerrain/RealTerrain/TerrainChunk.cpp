...
std::shared_ptr<TerrainChunk> TerrainChunk::CreateFrom(const std::vector<Vertex>& vertices,
...
void TerrainChunk::Draw(std::shared_ptr<Shader> shader) { mesh->Draw(shader); }
